    ...
    <div class="wrapper">
      <nav id="sidebar">
		...
		<ul class="list-items">
			...
			<li><a href=""><i class="fas fa-mail-bulk"></i>Add New Book</a></li>
			<li><a href=""><i class="fas fa-list-ol"></i>Book List</a></li>
			<li><a href=""><i class="fas fa-list-ol"></i>Customer List</a></li>
